...
<body class="bg-light">
    ...
    <div class="container-fluid p-4 header-gradient text-white shadow mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="?page=viewSubCategoria" class="btn btn-outline-light">
    ...
    <div class="col-12 mt-4">
        <button type="submit" href="?page=viewSubCategoria" name="addSubCategoria" class="btn btn-success btn-lg w-100 btn-submit"
