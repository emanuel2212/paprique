...
if (!empty($formData['AddCategoria'])) {
    ...
    if ($value) {
        ...
        header("Location: ?page=viewCategoria"); // Redireciona para a página de visualização de categorias
        ...
        <div class="form-container">
            ...
            <form method="POST" action="" class="row g-3">
                ...
                <div class="col-12 mt-4">
                    <button type="submit" href="?page=viewCategoria" name="AddCategoria" class="btn btn-success btn-lg w-100 btn-submit"
