    ...
    <div class="container mt-4">
        <div class="card shadow-sm">
            <div class="card-header text-white">
                <i class="fas fa-list me-1"></i> Lista de Status de Encomenda
            </div>
            <div class="card-body">
                <?php
                ...
                if (!empty($resultUsers)) {
                    ...
                    echo '<h4 class="text-muted">Nenhum status de encomenda encontrado</h4>';
                    echo '<p class="text-muted">Clique no botão "Cadastrar" para adicionar um novo status de encomenda</p>';
                    echo '</div>';
                }
                ?>
            </div>
