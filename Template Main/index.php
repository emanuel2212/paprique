			...
			<div class="inner-top">
				<div class="row">
					<div class="col-lg-8 offset-lg-2 col-12">
						...
						<div class="inner">
							<h4>Cadastre-se para receber</h4>
							<p> Ofertas recomendadas e preços exclusivos! <span>10%</span> Na sua Primeira compra</p>
							<form action="mail/mail.php" method="get" target="_blank" class="newsletter-inner">
								<input name="EMAIL" placeholder="Digite seu melhor email" required="" type="email">
