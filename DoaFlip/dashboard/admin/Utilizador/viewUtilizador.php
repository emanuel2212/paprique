    ...
    <div class="container-fluid p-4 bg-dark text-white shadow mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="?page=createUtilizador" class="btn btn-success">
            ...
            <div class="card-body">
                ...
                if (!empty($resultUsers)) {
                    ...
                    foreach ($resultUsers as $rowUser) {
                        ...
                        echo "<a href='?page=ListUtilizador&id=$id_utilizador' class='btn btn-secondary btn-sm btn-action'>
                                <i class='fas fa-eye'></i> VIsualizar
                               </a>";
                        echo "<a href='?page=editUtilizador&id=$id_utilizador' class='btn btn-warning btn-sm btn-action'>
                                <i class='fas fa-edit me-1'></i> Editar
                              </a>";
                         echo "<a href='javascript:void(0)' 
                                    onclick='if(confirm(\"Tem certeza que deseja excluir {$rowUser['username']}?\")) { window.location.href=\"?page=deleteUtilizador&id={$rowUser['id_utilizador']}\"; }' 
